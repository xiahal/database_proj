    ...
    public partial class Login : System.Windows.Forms.Form
    {
        ...
        private void StudentLoginButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    sql = "select * from pwd_users where uid = " + id + " and upasswd = " + pwd + " and ugroup = 3";
        ...
        private void TeacherLoginButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    sql = "select * from pwd_users where uid = " + id + " and upasswd = " + pwd + " and ugroup = 2";
        ...
        private void ManagerLoginButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string pwd = passwordBox.Text.Trim();
                string sql;
                //connectionStringLI = connectionStringLI + "uid=" + id + ";pwd=" + pwd;
                SqlConnection con = new SqlConnection(connectionString);//创建-个数据库连接
                if (id[0] != '1')
                {
                    MessageBox.Show("Your ID is invalid! Try AGAIN.");
                ...
                {
                    sql = "select * from pwd_users where uid = " + id + " and upasswd = " + pwd + " and ugroup = 1";
